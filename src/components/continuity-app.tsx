...
type View = {
  ...
  decision: null | { profile: string; selectedPortfolio: string; weights: Record<string, number>; portfolios: Array<{ type: string; label: string; itemSnapshotIds: string[]; totalPricePaise: number; missionUtility: number; marginalValue: number; tradeOff: string }> };
