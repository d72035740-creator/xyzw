...
export function ContinuityApp() {
  ...
  async function build() {
    await run("SEARCHING MARKET · RESEARCHING EVIDENCE · OPTIMIZING AUTHORITY", async () => setView(await request<View>("/api/continuity/missions", { method: "POST", body: JSON.stringify(missionInput()) })));
  }
